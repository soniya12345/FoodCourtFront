...
import com.niit.FoodCourt.dao.CategoryDAO;
import com.niit.FoodCourt.dao.My_CartDAO;
import com.niit.FoodCourt.dao.ProductDAO;
...
public class HomeController {
	...
	public ModelAndView goToHome() {
		...
		mv.addObject("message", "WELCOME TO  FOOD COURT WEBSITE <br>");
	...
	public ModelAndView goToHomeButton() {
		...
		mv.addObject("User", loggedInUserID);
